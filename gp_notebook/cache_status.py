...
CACHE_SPECS: tuple[CacheSpec, ...] = (
    ...
    CacheSpec("intervention_sweeps.parquet", "optional", "M5 slider interpolation"),
    ...
    CacheSpec("atp_ig_features.json", "optional", "AtP-IG top features demo"),
    CacheSpec("probe_figure5.json", "optional", "Structural probe Figure 5"),
