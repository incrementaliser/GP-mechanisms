...
The source of this script is: https://github.com/iruletheworld/matplotlib-curly-brace/tree/master
...
# def curlyBrace(fig, ax, p1, p2, k_r=0.1, bool_auto=True, str_text='', int_line_num=2, fontdict={}, **kwargs):
    ...
    **kwargs : matplotlib line setting arguments
    ...
    # plot arcs
    a1 = ax.plot(arc1x, arc1y, **kwargs)
    a2 = ax.plot(arc2x, arc2y, **kwargs)
    a3 = ax.plot(arc3x, arc3y, **kwargs)
    a4 = ax.plot(arc4x, arc4y, **kwargs)

    # plot lines
    a5 = ax.plot([arc1x[-1], arc2x[1]], [arc1y[-1], arc2y[1]], **kwargs)
    a6 = ax.plot([arc3x[-1], arc4x[1]], [arc3y[-1], arc4y[1]], **kwargs)
    artists = [a[0] for a in [a1, a2, a3, a4, a5, a6]]
    ...
    if str_text:
        ...
        a7 = ax.axes.text(arc2x[-1], arc2y[-1], str_text, ha='center', va='center', rotation=rotation, fontdict=fontdict)
        artists.append(a7)
    ...
    return theta, summit, arc1, arc2, arc3, arc4, artists